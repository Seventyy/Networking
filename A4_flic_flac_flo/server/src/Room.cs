...
namespace server
{
    ...
    abstract class Room
    {
        ...
        private Dictionary<TcpMessageChannel, PlayerInfo> _members;
        
        public Dictionary<TcpMessageChannel, PlayerInfo> Members
        {
            get { return _members; }
        }
...
*/
        ...
        {
            _server = pServer;
            _members = new Dictionary<TcpMessageChannel, PlayerInfo>();
        }


        protected virtual void addMember(TcpMessageChannel pMember, PlayerInfo playerInfo)
        {
            Log.LogInfo("Client joined.", this);
            _members.Add(pMember, playerInfo);
        }
        ...
        {
            return _members.Keys.ToList().IndexOf(pMember);
        }
        ...
        */
        protected void safeForEach(Action<TcpMessageChannel> pMethod)
        {
            for (int i = _members.Count - 1; i >= 0; i--)
            {
                ...
                pMethod(_members.Keys.ToList()[i]);
            }
        }
...
*/
        protected void removeAndCloseMember(TcpMessageChannel pMember)
        {
            ...
            if (pMember.Connected) pMember.Close();
